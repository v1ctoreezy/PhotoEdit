...
//  PhotoEditing-iOS
//
//  Created by Victor Cherkasov on 25.07.2025.
//
...
enum LUTConverter {
    public static func makeCIFilter(
        lutImage: UIImage,
        dimension: Int,
        colorSpace: CGColorSpace
    ) -> CIFilter {
        let lutData = getLutData(lutImage: lutImage, dimension: dimension, colorSpace: colorSpace)!
    ...
    public static func getLutData(lutImage: UIImage, dimension: Int, colorSpace: CGColorSpace) -> Data? {
