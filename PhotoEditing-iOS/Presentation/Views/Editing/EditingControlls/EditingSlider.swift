...
//  PhotoEditing-iOS
//
//  Created by Victor Cherkasov on 29.08.2025.
//

import SwiftUI
import PixelEnginePackage

struct EditingSliderMenu: View {
    ...
    var body: some View {
        VStack {
            ...
            EditingSlider(filterIntensity: $value)
            ...
            HStack {
                Img.Icons.DsIcons.icCross
                    ...
                    .resizable()
                    .scaledToFill()
                    .foregroundColor(.appBWVariants200400)
    ...
    var body: some View{
        ...
        VStack(spacing: spacing){
            ...
            CustomSlider(value: $value, defaultValue: defaultValue ,range: range) { modifiers in
                ZStack {
                    Color.appRed300.cornerRadius(1).frame(height: 1).modifier(modifiers.bar)
                    Circle()
                        .fill(Color.appRed000)
                        .frame(height: 5)
                        .modifier(modifiers.defaultDot)
                    ZStack {
                        Circle()
                            .fill(Color.appRed600)
                        Circle().stroke(Color.appRed000, lineWidth: 1)
